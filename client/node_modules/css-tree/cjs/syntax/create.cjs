...
const create = require('css-tree/cjs/parser/create.cjs');
const create$2 = require('css-tree/cjs/generator/create.cjs');
const create$3 = require('css-tree/cjs/convertor/create.cjs');
const create$1 = require('css-tree/cjs/walker/create.cjs');
const Lexer = require('css-tree/cjs/lexer/Lexer.cjs');
const mix = require('css-tree/cjs/syntax/config/mix.cjs');
