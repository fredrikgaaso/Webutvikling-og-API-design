...
const error = require('css-tree/cjs/lexer/error.cjs');
const names = require('css-tree/cjs/utils/names.cjs');
const genericConst = require('css-tree/cjs/lexer/generic-const.cjs');
const generic = require('css-tree/cjs/lexer/generic.cjs');
const units = require('css-tree/cjs/lexer/units.cjs');
const prepareTokens = require('css-tree/cjs/lexer/prepare-tokens.cjs');
const matchGraph = require('css-tree/cjs/lexer/match-graph.cjs');
const match = require('css-tree/cjs/lexer/match.cjs');
const trace = require('css-tree/cjs/lexer/trace.cjs');
const search = require('css-tree/cjs/lexer/search.cjs');
const structure = require('css-tree/cjs/lexer/structure.cjs');
const parse = require('css-tree/cjs/definition-syntax/parse.cjs');
const generate = require('css-tree/cjs/definition-syntax/generate.cjs');
const walk = require('css-tree/cjs/definition-syntax/walk.cjs');
