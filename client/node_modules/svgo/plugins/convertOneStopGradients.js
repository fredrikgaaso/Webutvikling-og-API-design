...
const { attrsGroupsDefaults, colorsProps } = require('svgo/plugins/_collections');
const {
  detachNodeFromParent,
  querySelectorAll,
  querySelector,
} = require('svgo/lib/xast');
const { computeStyle, collectStylesheet } = require('svgo/lib/style');
 ...
 * @type {import('svgo/plugins/plugins-types').Plugin<'convertOneStopGradients'>}
