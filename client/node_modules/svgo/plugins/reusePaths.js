...
const { collectStylesheet } = require('svgo/lib/style');
const { detachNodeFromParent, querySelectorAll } = require('svgo/lib/xast');
 ...
 *
 * @type {import('svgo/plugins/plugins-types').Plugin<'reusePaths'>}
 */
exports.fn = (root) => {
