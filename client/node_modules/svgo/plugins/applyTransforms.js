...
const {
  ...
  transform2js,
  transformArc,
} = require('svgo/plugins/_transforms.js');
const { path2js } = require('svgo/plugins/_path.js');
const { removeLeadingZero } = require('svgo/lib/svgo/tools.js');
const { referencesProps, attrsGroupsDefaults } = require('svgo/plugins/_collections.js');
