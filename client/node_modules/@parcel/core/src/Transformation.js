...
import type {LoadedPlugin} from '@parcel/core/src/ParcelConfig';
...
import {ResolverRunner} from '@parcel/core/src/requests/PathRequest';
import {
  Asset,
  MutableAsset,
  mutableAssetToUncommittedAsset,
} from '@parcel/core/src/public/Asset';
import UncommittedAsset from '@parcel/core/src/UncommittedAsset';
import {
  createAsset,
  getInvalidationId,
  getInvalidationHash,
} from '@parcel/core/src/assetUtils';
import summarizeRequest from '@parcel/core/src/summarizeRequest';
import PluginOptions from '@parcel/core/src/public/PluginOptions';
import {PARCEL_VERSION, FILE_CREATE} from '@parcel/core/src/constants';
...
import {invalidateOnFileCreateToInternal} from '@parcel/core/src/utils';
