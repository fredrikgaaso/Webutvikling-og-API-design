...
var _package = _interopRequireDefault(require("@parcel/cache/package.json"));
function _lmdb() {
...
var _constants = require("@parcel/cache/lib/constants");
...
class LMDBCache {
  ...
  async setLargeBlob(key, contents) {
    ...
    if (chunks === 1) {
      ...
      await this.fs.writeFile(_classPrivateMethodGet(this, _getFilePath, _getFilePath2).call(this, key, 0), contents);
      return;
    }
    const writePromises = [];
