  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@parcel/rust/parcel-node-bindings.win32-x64-msvc.node')
          } else {
  ...
  case 'darwin':
    ...
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@parcel/rust/parcel-node-bindings.darwin-x64.node')
          } else {
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@parcel/rust/parcel-node-bindings.darwin-arm64.node')
          } else {
    ...
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@parcel/rust/parcel-node-bindings.linux-x64-musl.node')
            } else {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@parcel/rust/parcel-node-bindings.linux-x64-gnu.node')
            } else {
      ...
      case 'arm64':
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@parcel/rust/parcel-node-bindings.linux-arm64-musl.node')
            } else {
          ...
          try {
            if (localFileExisted) {
              nativeBinding = require('@parcel/rust/parcel-node-bindings.linux-arm64-gnu.node')
            } else {
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('@parcel/rust/parcel-node-bindings.linux-arm-gnueabihf.node')
          } else {
