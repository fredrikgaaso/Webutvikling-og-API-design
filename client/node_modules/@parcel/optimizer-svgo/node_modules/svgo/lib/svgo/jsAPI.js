...
const svgoCssSelectAdapter = require('svgo/lib/svgo/css-select-adapter');
const CSSClassList = require('svgo/lib/svgo/css-class-list');
const CSSStyleDeclaration = require('svgo/lib/svgo/css-style-declaration');
