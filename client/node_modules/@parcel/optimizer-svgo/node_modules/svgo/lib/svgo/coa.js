...
const pluginsMap = require('svgo/plugins/plugins.js');
const PKG = require('svgo/package.json');
const { encodeSVGDatauri, decodeSVGDatauri } = require('svgo/lib/svgo/tools.js');
