 ...
 * @typedef {import('svgo/lib/types').XastRoot} XastRoot
 * @typedef {import('svgo/lib/types').XastElement} XastElement
 * @typedef {import('svgo/lib/types').XastInstruction} XastInstruction
 * @typedef {import('svgo/lib/types').XastDoctype} XastDoctype
 * @typedef {import('svgo/lib/types').XastText} XastText
 * @typedef {import('svgo/lib/types').XastCdata} XastCdata
 * @typedef {import('svgo/lib/types').XastComment} XastComment
 * @typedef {import('svgo/lib/types').StringifyOptions} StringifyOptions
 */

const { textElems } = require('svgo/plugins/_collections.js');
