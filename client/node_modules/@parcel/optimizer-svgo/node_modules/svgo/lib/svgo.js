...
} = require('svgo/lib/svgo/config.js');
const { parseSvg } = require('svgo/lib/parser.js');
const { stringifySvg } = require('svgo/lib/stringifier.js');
const { invokePlugins } = require('svgo/lib/svgo/plugins.js');
const JSAPI = require('svgo/lib/svgo/jsAPI.js');
const { encodeSVGDatauri } = require('svgo/lib/svgo/tools.js');
