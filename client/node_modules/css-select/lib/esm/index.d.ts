import type { CompiledQuery, Options, Query, Adapter } from "css-select/lib/esm/types.js";
export type { Options };
/**
...
export declare const _compileToken: <Node, ElementNode extends Node>(selector: import("css-select/lib/esm/types.js").InternalSelector[][], options?: Options<Node, ElementNode> | undefined, context?: Node | Node[] | undefined) => CompiledQuery<ElementNode>;
...
export { filters, pseudos, aliases } from "css-select/lib/esm/pseudo-selectors";
