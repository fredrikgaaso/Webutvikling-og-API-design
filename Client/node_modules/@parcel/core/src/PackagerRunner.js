...
import type {ConfigRequest} from '@parcel/core/src/requests/ConfigRequest';
import type {DevDepSpecifier} from '@parcel/core/src/requests/DevDepRequest';
...
import {NamedBundle, bundleToInternalBundle} from '@parcel/core/src/public/Bundle';
import BundleGraph, {
  bundleGraphToInternalBundleGraph,
} from '@parcel/core/src/public/BundleGraph';
import PluginOptions from '@parcel/core/src/public/PluginOptions';
import PublicConfig from '@parcel/core/src/public/Config';
import {PARCEL_VERSION, HASH_REF_PREFIX, HASH_REF_REGEX} from '@parcel/core/src/constants';
import {
  fromProjectPath,
  toProjectPathUnsafe,
...
import {createBuildCache} from '@parcel/core/src/buildCache';
import {getInvalidationId, getInvalidationHash} from '@parcel/core/src/assetUtils';
import {optionsProxy} from '@parcel/core/src/utils';
import {invalidateDevDeps} from '@parcel/core/src/requests/DevDepRequest';
