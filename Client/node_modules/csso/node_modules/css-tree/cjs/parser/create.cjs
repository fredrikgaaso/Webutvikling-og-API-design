...
const List = require('css-tree/cjs/utils/List.cjs');
const SyntaxError = require('css-tree/cjs/parser/SyntaxError.cjs');
const index = require('css-tree/cjs/tokenizer/index.cjs');
const sequence = require('css-tree/cjs/parser/sequence.cjs');
const OffsetToLocation = require('css-tree/cjs/tokenizer/OffsetToLocation.cjs');
const TokenStream = require('css-tree/cjs/tokenizer/TokenStream.cjs');
const utils = require('css-tree/cjs/tokenizer/utils.cjs');
const types = require('css-tree/cjs/tokenizer/types.cjs');
const names = require('css-tree/cjs/tokenizer/names.cjs');
