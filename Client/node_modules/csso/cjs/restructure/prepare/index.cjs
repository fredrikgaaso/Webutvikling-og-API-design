...
const createDeclarationIndexer = require('csso/cjs/restructure/prepare/createDeclarationIndexer.cjs');
const processSelector = require('csso/cjs/restructure/prepare/processSelector.cjs');
