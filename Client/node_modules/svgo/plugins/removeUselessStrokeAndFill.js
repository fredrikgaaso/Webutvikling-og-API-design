...
const { visit, visitSkip, detachNodeFromParent } = require('svgo/lib/xast.js');
const { collectStylesheet, computeStyle } = require('svgo/lib/style.js');
const { hasScripts } = require('svgo/lib/svgo/tools.js');
const { elemsGroups } = require('svgo/plugins/_collections.js');
 ...
 * @author Kir Belevich
 *
 * @type {import('svgo/plugins/plugins-types').Plugin<'removeUselessStrokeAndFill'>}
 */
