...
const { elemsGroups, referencesProps } = require('svgo/plugins/_collections.js');
const {
  visit,
  visitSkip,
  querySelector,
...
const { parsePathData } = require('svgo/lib/path.js');
 ...
 * @author Kir Belevich
 *
 * @type {import('svgo/plugins/plugins-types').Plugin<'removeHiddenElems'>}
 */
