...
const { visit } = require('svgo/lib/xast.js');
const { pathElems } = require('svgo/plugins/_collections.js');
const { path2js, js2path } = require('svgo/plugins/_path.js');
const { applyTransforms } = require('svgo/plugins/applyTransforms.js');
const { cleanupOutData } = require('svgo/lib/svgo/tools');
 ...
 * @author Kir Belevich
 *
 * @type {import('svgo/plugins/plugins-types').Plugin<'convertPathData'>}
 */
