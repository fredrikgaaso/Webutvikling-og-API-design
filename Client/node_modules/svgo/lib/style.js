 ...
 * @typedef {import('svgo/lib/types').Specificity} Specificity
 * @typedef {import('svgo/lib/types').Stylesheet} Stylesheet
 * @typedef {import('svgo/lib/types').StylesheetRule} StylesheetRule
 * @typedef {import('svgo/lib/types').StylesheetDeclaration} StylesheetDeclaration
 * @typedef {import('svgo/lib/types').ComputedStyles} ComputedStyles
...
const { visit, matches } = require('svgo/lib/xast.js');
const {
  attrsGroups,
  inheritableAttrs,
  presentationNonInheritableGroupAttrs,
} = require('svgo/plugins/_collections.js');
